...
export function AuthCard({ title, description, children }: AuthCardProps) {
  return (
    <Card className="w-full max-w-[780px] border-app bg-app-surface/96 shadow-[0_24px_90px_-52px_rgba(15,23,42,0.7)] backdrop-blur-sm dark:shadow-[0_24px_90px_-56px_rgba(0,0,0,0.85)]">
